...
import { Project, Skill, Testimonial, Service } from '../models/types';

export const PERSONAL_DETAILS = {
  name: "Md. Ziaul Haque",
  shortName: "Ziaul",
  title: "Professional Flutter App Developer",
  email: "mdziaulhoquesp94@gmail.com",
  phone: "+8801889564894",
  location: "Dhaka, Bangladesh",
  // IMPORTANT: Upload your image to the /assets/ folder and name it profile.jpg
